...
public class EraserSettingsController {
    ...
    public void setCanvasController(CanvasController canvasController) {
        ...
        try {
            ...
            this.canvasController.setEraserSize(initialSize);
    ...
    public void initialize() {
                ...
                try {
                    ...
                    if (value >= slider.getMin() && value <= slider.getMax()) {
                        ...
                        if (canvasController != null) {
                            canvasController.setEraserSize(value);
                        }
                    }
                } catch (NumberFormatException e) {
        ...
        slider.valueProperty().addListener((obs, oldVal, newVal) -> {
            ...
            if (canvasController != null) {
                canvasController.setEraserSize(newVal.intValue()); // Обновляем размер кисти в CanvasController
            }
        });
